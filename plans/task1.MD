...
- [This is the base](/app/tui/app.py) of the TUI. The Textual `header` widget is present on the same row as the title text "dockerDocker by @thesavant42"
...
Task 1. Need to include a textual "text" type [Input Widget](./plans/input.md/) in the `TOP PANEL`, that submits to `/search.data`
