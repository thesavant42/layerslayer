...
These can only be performed after a `layer-peek` or a `peek-all` to first parse the tar images and populate the database.
...
fs-log-sqlite.py Search is documented here [docs\api\SEARCH.md](docs\api\SEARCH.md)